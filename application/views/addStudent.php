...
<div class="container mt-4 bg-secondery">    
    <div class="jumbotron">    
        <h1>ADD STUDENT </h1>
        <hr>
        <form action="<?php echo base_url() . 'admin1/createStudent' ?>" class="form-horizontal" method="post">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="studentname" placeholder="Enter username"  value="<?php echo set_value('studentname'); ?>" />
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="course" placeholder="Enter course"  value="<?php echo set_value('course'); ?>" />
